...
function ProfileStackScreen(props) {
  ...
  console.log(
    "ProfileStackScreen: Received props:",
...
function AvailabilityStackScreen() {
  return (
    <MatchPortalStack.Navigator screenOptions={{ headerShown: false }}>
      ...
      />
      <MatchPortalStack.Screen name="MatchCompare" component={MatchCompare} />
      <MatchPortalStack.Screen name="SelectLiaison" component={SelectLiaison} />
...
function TabNavigator({ route }) {
  ...
  console.log(
    `TabNavigator: Initial tab set to ${initialTabName}, showWelcome: ${showWelcomeAnimation}`
  );
