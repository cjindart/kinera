...
const testUsers = [
  ...
  // New user 1
  {
    ...
    updatedAt: new Date().toISOString(),
    createdAt: new Date().toISOString(),
    stanfordEmail: "ethompson@stanford.edu",
    isStanfordVerified: true,
    profileData: {
      age: 24,
      gender: "female",
      height: 168,
      year: "Senior",
      interests: ["Dance", "Photography", "Hiking"],
      dateActivities: ["Dance classes", "Photo walks", "Hiking trails"],
  ...
  // New user 2
  {
    ...
    updatedAt: new Date().toISOString(),
    createdAt: new Date().toISOString(),
    stanfordEmail: "dpark@stanford.edu",
    isStanfordVerified: true,
    profileData: {
      age: 25,
      gender: "male",
      ...
      dateActivities: ["Basketball games", "Hackathons", "Concerts"],
